...
from src.mmdet3d.apis import single_gpu_test
from src.mmdet3d.datasets import build_dataloader, build_dataset
from src.mmdet3d.models import build_model
from mmdet.apis import multi_gpu_test, set_random_seed
from mmdet.datasets import replace_ImageToTensor
from src.mmdet3d.utils import recursive_eval
...
def main():
    ...
    for data in data_loader:
        ...
        gt_bboxes_3d=[gt_bboxes_3d[0].to("cuda")]
